...
<body bgcolor=#FFFFFF text=#000000 leftmargin=0 topmargin=0
		...
		<tr>
			...
			<td>
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590"
					...
					%>
					<tr>
						<td width=190 align=center bgcolor="ffffff" height="20"><%=userinfo.getUserid()%>
						</td>
						<td width=200 align=center bgcolor="ffffff"><a
							href="user_view.jsp?userid=<%=userinfo.getUserid()%>"
							class="user"> <%=userinfo.getName()%>
						</a></td>
						<td width=200 align=center bgcolor="ffffff"><%=userinfo.getEmail()%>
						</td>
					</tr>
					<%
					}
 ...
 %> <input type="button" value="로그아웃"
							onclick="location.href='user_logout_action.jsp';" />
						</td>
					</tr>
				</table>
			</td>
