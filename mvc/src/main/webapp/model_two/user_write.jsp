...
<link rel=stylesheet href="<c:url value="/model_two/css/user.css"/>"
	type="text/css">
	...
	<table width=780 border=0 cellpadding=0 cellspacing=0>
		...
		<tr>
			...
			<td>
					...
					<table border="0" cellpadding="0" cellspacing="1" width="590"
						...
						<tr>
							...
							<td width=490 bgcolor="ffffff" style="padding-left: 10px;">
								<select name="status">
									<option value="1"
										<c:if test="${userinfo.status == 1 }">selected</c:if>>일반회원</option>
									<option value="9"
										<c:if test="${userinfo.status == 9 }">selected</c:if>>관리자</option>
							</select>
							</td>
						</tr>
					</table>
				...
				<table width=590 border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td align=center><input type="button" value="회원등록"
							onClick="userCreate();"> <input type="button" value="로그인"
							onClick="location.href='<c:url value="/loginform.do"/>';">
						</td>
					</tr>
				</table>
			</td>
